...
public class PinView extends AppCompatEditText {
    ...
    private vn.payme.sdk.component.PinView.Blink mBlink;
    ...
    private void drawCircleHiden(Canvas canvas, int i) {
        Paint paint = getPaintByIndex(i);
        float cx = mItemCenterPoint.x;
        float cy = mItemCenterPoint.y;
        paint.setAlpha(50);
    ...
    private void makeBlink() {
        if (shouldBlink()) {
            if (mBlink == null) {
                mBlink = new vn.payme.sdk.component.PinView.Blink();
            }
    ...
    private void disableSelectionMenu() {
        setCustomSelectionActionModeCallback(new vn.payme.sdk.component.PinView.DefaultActionModeCallback());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            setCustomInsertionActionModeCallback(new vn.payme.sdk.component.PinView.DefaultActionModeCallback() {
                @Override
