    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        paymentApi.getTransferMethods(onSuccess = { jsonObject ->
            ...
            for (i in 0 until jsonArray.length()) {
                ...
                this.listMethod.add(Method(detail, linkedId, bankCode, amount, type, cardNumber, swiftCode, selected = i === 0))
        ...
        buttonSubmit.setOnClickListener {
            ...
            if (method.type == TYPE_PAYMENT.NAPAS) {
...
//                    println("FROM :"+form)
                    ...
                    val confirmOtpNapasFragment: ConfirmOtpNapasFragment = ConfirmOtpNapasFragment()
            ...
            if (method.type == TYPE_PAYMENT.PVCB) {
